...
class WebAudioRecorder {
  ...
  async startRecording() {
    ...
    try {
      // Request microphone access (triggers Windows permission dialog)
      ...
      if (error.name === 'NotAllowedError' || error.name === 'PermissionDeniedError') {
        throw new Error('Microphone permission denied. Please grant microphone access to Speak.');
      ...
      try {
        ...
        this.mediaRecorder.onstop = async () => {
          try {
            ...
            fs.writeFileSync(this.tempFile, Buffer.from(wavBuffer));

            console.log(`Recording stopped, saved ${wavBuffer.byteLength} bytes to ${this.tempFile}`);
...
module.exports = new WebAudioRecorder();
